 ...
 */
function fillRtpParametersForTrack(param)
{
    const rtpParameters = param.rtpParameters;
    const sdpObj = param.sdpObj;
    const track = param.track;
    const options = param.options;
    
    const mid = options.mid;
    const planBSimulcast = options.planBSimulcast
 ...
 * @param {String} [mid]
 */
function addPlanBSimulcast(param)
{
    const sdpObj    = param.sdpObj;
    const track     = param.track;
    const mid       = param.mid || null;
    const mSection  = findMediaSection(sdpObj, track, mid);
